package vianditasONG.modelos.servicios.seguridad.config;
...
public class Config {
    ...
    private Config() {
        try (InputStream input = getClass().getClassLoader().getResourceAsStream("configs/seguridad/config.properties")) {
            if (input == null) {
