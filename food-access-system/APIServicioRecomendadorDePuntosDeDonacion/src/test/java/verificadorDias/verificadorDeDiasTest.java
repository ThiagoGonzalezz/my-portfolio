...
public class verificadorDeDiasTest {
    VerificadorDiasAbierto verificadorDiasAbierto;
    ...
    public void inicializar(){
        verificadorDiasAbierto = VerificadorDiasAbierto.builder().build();
    ...
    @Test()
    @DisplayName("retorna falso cuando ningun dia coincide con uno buscado")
    public void refutarCoincidenciaEnDias(){
        Assertions.assertNotEquals(true, verificadorDiasAbierto.coincideAlgunDia(puntoDeDonacion3, List.of(DayOfWeek.MONDAY)));
    }

    @Test()
    @DisplayName("retorna verdadero cuando algun dia coincide con el buscado")
    public void confirmarCoincidenciaEnDias(){
        Assertions.assertEquals(true, verificadorDiasAbierto.coincideAlgunDia(puntoDeDonacion1, List.of(DayOfWeek.MONDAY)));
    }
}
